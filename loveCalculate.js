...
function getDeathYear(date) {
  let val =
    getSum(date.getFullYear()) +
    getSum(date.getMonth()) +
    getSum(date.getDate());
...
function SumOnDate(date) {
  let val =
    getSumForFriendship(date.getFullYear()) +
    getSumForFriendship(date.getMonth()) +
    getSumForFriendship(date.getDate());
...
function isValidFriendshipForm() {
  ...
  if (check) {
    ...
    var friend_gender =
      document.forms["friendship-Form"]["inputFriendGender"].value;
    var friend_name =
      document.forms["friendship-Form"]["inputFriendName"].value;
    var friend_zodiac =
      document.forms["friendship-Form"]["inputFriendZodiac"].value;
    score = getFriendshipScore(
      user_name,
      friend_name,
      user_gender,
      friend_gender,
...
function isValidLuckyColorForm() {
  ...
  if (check) {
    ...
    document.getElementById("unlucky-colors").innerHTML =
      unlucky_colors_together;
...
function getMarriageNumberResult(result) {
  switch (result) {
    ...
    case 8:
      return "The number eight is the symbol of infinity. It is the ultimate goal for everyone â€“ everlasting and continuous existence. This number is also related to a sense of protection, power and authority. While the number seven is somewhat gloomy, the number eight is optimistic and promising.";
    case 9:
...
function getHateScore(name1, gender1, date1, name2, gender2, date2, known) {
  ...
  score =
    score +
    SumOnHateDate(new Date(date1)) +
    SumOnHateDate(new Date(date2)) +
    glist[gender1] +
    glist[gender2] +
    parseInt(known);
  while (score > 100) {
...
function SumOnHateDate(date) {
  let val =
    getHateDateSum(date.getFullYear()) +
    getHateDateSum(date.getMonth()) +
    getHateDateSum(date.getDate());
  let result = getSum(val);
  return result;
}
...
function isValidFlamesForm() {
  ...
  if (check) {
    ...
    document.getElementById("flames-score").innerHTML =
      flamesDataSet[(str2.length + str1.length) % 6];
...
function isValidExpressionForm() {
  ...
  if (check) {
    ...
    document.getElementById("data-result").innerHTML =
      getExpressionNumberResult(score);
...
function isValidPersonalityForm() {
  ...
  if (check) {
    ...
    document.getElementById("data-result").innerHTML =
      getPersonalityNumberResult(score);
...
function getWifeScore(str1, str2, ques1, ques2, weddingtype, anivdate, known) {
  ...
  score =
    ...
    parseInt(ques1) * 3 +
    parseInt(ques2) * 3 +
    parseInt(weddingtype) +
    SumOnAnyDate(anivdate) +
    parseInt(known);
  while (score > 100) {
    score = score % 100;
  }
...
function getBreakUpScore(str1, str2, ques1, ques2, yearKnown) {
  ...
  score =
    score + parseInt(ques1) * 10 + parseInt(ques2) * 10 + parseInt(yearKnown);
  while (score > 100) {
    score = score % 100;
  }
  return score;
  ...
  if (check) {
    ...
    if (validdate) {
      ...
      document.getElementById("number-1").innerHTML =
        getPeriodCycleNumberResult(monthNo);
      document.getElementById("number-2").innerHTML =
        getPeriodCycleNumberResult(dateNo);
      document.getElementById("number-3").innerHTML =
        getPeriodCycleNumberResult(yearNo);
...
function getSoulUrgeNumberResult(result) {
  switch (result) {
    case 1:
      return "Soul urge number one symbolises independence and self-sufficiency. It is the sign of a great leaderâ€”confident in their abilities and unafraid to make challenging conclusions. If your heart's desire number is 1, your soul's urge is to be a boss. However, if your soul number is one, you may also have a competitive attitude that must be tamed.";
    case 2:
      return "Do sad movies make you cry? Do you often switch off the news? If you've ended up with a soul number 2, you are an emotional soul. Your most tremendous urge is to feel secure and comfortable. While you may sometimes hate your sensitivity but behind it hides a beautiful assetâ€”the powerful intuition. You must learn to trust it and stand up for what you feel is correct because your judgments are often spot on!";
    case 3:
...
function getInnerDreamNumberResult(result) {
  switch (result) {
    ...
    case 6:
      return "Venusâ€™ influence is apparent on this number. People like you are responsible, supportive, and helpful. Your loving and empathetic energy makes everyone feel safe around you.";
    case 7:
      return "Neptune influences the number 7. As much as you are elegant, you also possess a certain level of wariness. You may be unwilling to trust people immediately, but once you let your guard down, youâ€™re one of the most pleasing people to be around.";
    case 8:
...
function getInnerDreamCalc() {
  ...
  if (check) {
    ...
    document.getElementById("data-result").innerHTML =
      getInnerDreamNumberResult(result);
...
function getLuckyNumber() {
  ...
  if (check) {
    ...
    if (validdate) {
      ...
      document.getElementById("personalityNumber").innerHTML =
        personalityNumber;
...
function getKarmic(date, month, year) {
  ...
  if (result == 4) {
    ...
    return {
      lifepath: result,
      karmic:
        "You Don't have any Karmic debt number associated with life path number.",
    };
  }
}
  ...
  if (check) {
    ...
    if (validdate) {
      ...
      if (isNaN(score.karmic)) {
        ...
        document.getElementById("checkContentShow").style.display =
          "inline-block";
        document.getElementById("karmic-debt-score").innerHTML = score.karmic;
        document.getElementById("data-result").innerHTML =
          getKarmicNumberResult(score.karmic);
      }
...
function getBoyfriendScore(str1, str2, ques1, ques2, yearKnown) {
  ...
  score =
    score + parseInt(ques1) * 3 + parseInt(ques2) * 3 + parseInt(yearKnown);
  while (score > 100) {
    score = score % 100;
  }
  return score;
...
function isValidMinorExpressionForm() {
  ...
  if (check) {
    ...
    document.getElementById("expression-score").innerHTML = score;
    document.getElementById("data-result").innerHTML =
      getMinorExpressionNumberResult(score);
    target = $("#custom-expression-modal").attr("data-target-custom");
    $(target).modal("show");
  }
}
